...
public class Split_Method_Expect_2_External_Data {
    public static void main(String[] args) {
        ...
        //TASK: PRINT OUT EACH CAR THAT ITS MODEL HAS 2 CHARACTER
        ...
        System.out.println("\t");
        //TASK: PRINT OUT EACH CAR THAT ITS MODEL HAS 3 CHARACTER
        int cnt=0;
        for( String eachCar : cars ){
           String[] eachCarSplit = eachCar.split("-",3);
           if(eachCarSplit[1].length() == 3){
               cnt++;
               System.out.println(eachCar);
           }
        }
        System.out.println("There are "+cnt+ " cars that has 3 character in their models");
    }
