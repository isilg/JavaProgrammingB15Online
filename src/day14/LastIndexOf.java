...
public class LastIndexOf {
    public static void main(String[] args) {
        ...
        System.out.print("find out last location the letter a shows up: ");
        System.out.println(name.lastIndexOf("a"));

        // find out last location the character space shows up
        System.out.print("find out last location the character space shows up: ");
        System.out.println(name.lastIndexOf(" "));

        // find out last location the letter Ga shows up
        System.out.print("find out last location the letter Ga shows up: ");
        System.out.println(name.lastIndexOf("Ga"));


        // find out last location the letter Kawa shows up
        System.out.print("find out last location the letter Kawa shows up: ");
        System.out.println(name.lastIndexOf("Kawa"));


        //  if i DONT USE contains method , what would be my condition to check whether we have Kawa in this String , either using indexOf or lastIndex ?
